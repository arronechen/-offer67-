...
public class Solution {
     ...
     *
     ...
     我们知道10-19这组数，每隔100出现一次，这次我们的阶梯是100，例如数字317，分析有阶梯0-99，100-199，
     200-299三段完整阶梯，每一段阶梯里面都会出现10次1（从10-19），最后分析露出来的那段不完整的阶梯。
    ...
    public static int newNumberOf1Between1AndN_Solution(int n) {
        int count = 0;//count(i) = (n / (i * 10)) * i + (if(k > i * 2 - 1) i else if(k < i) 0 else k - i + 1)
        for (int i = 1;i<n;i*=10){
            int count1 = n/(i*10)*i;//n/100*10 != n/10
            int count2;
            int k = n%(i*10);
            if (k>2*i-1){
                count2 = i;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(newNumberOf1Between1AndN_Solution(n));
